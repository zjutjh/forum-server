...
create table attachment (
    id int not null comment '附件ID' primary key,
...
create table college (
    id int not null comment '学院ID' primary key,
...
create table comment (
    id int not null comment '评论ID' primary key,
...
create table faq (
    id int not null comment '常见问题ID' primary key,
...
create table favorite (
    id int not null comment '收藏ID' primary key,
    user_id int not null comment '用户ID',
    post_id int not null comment '帖子ID',
    created_at timestamp default CURRENT_TIMESTAMP not null comment '创建时间',
    updated_at timestamp not null on update CURRENT_TIMESTAMP comment '更新时间',
...
create table feedback (
    id int not null comment '意见反馈ID' primary key,
    user_id int not null comment '用户ID',
...
create table file (
    id int not null comment '文件ID' primary key,
...
create table follow (
    id int not null comment '关注ID' primary key,
    user_id int not null comment '用户ID',
    target_id int not null comment '关注对象ID',
...
create table notice (
    id int not null comment '互动通知ID' primary key,
    ...
    comment_id int not null comment '评论ID（type为comment或at时有效）',
    created_at timestamp default CURRENT_TIMESTAMP not null comment '创建时间',
    updated_at timestamp not null on update CURRENT_TIMESTAMP comment '更新时间',
    create_uid int not null comment '创建用户',
    update_uid int not null comment '更新用户',
...
create table operation_log (
    id int not null comment '修改记录ID' primary key,
    type varchar(20) not null comment '修改类型',
    target_id int not null comment '修改对象ID',
    user_id int not null comment '修改用户ID',
...
create table post (
    id int not null comment '帖子ID' primary key,
...
create table post_category (
    id int not null comment '帖子板块ID' primary key,
...
create table post_topic_relation (
    id int not null comment '关联ID' primary key,
    post_id int not null comment '帖子ID',
...
create table report (
    id int not null comment '举报ID' primary key,
    user_id int not null comment '用户ID',
...
create table topic (
    id int not null comment '话题ID' primary key,
...
create table upvote (
    id int not null comment '点赞ID' primary key,
    user_id int not null comment '用户ID',
